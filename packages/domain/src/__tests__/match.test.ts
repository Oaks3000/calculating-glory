...
describe('clubToTeam', () => {
  it('creates a Team from a Club with players', () => {
    const club: Club = {
      ...
      wageBudget: 0,
      squad: [
        { id: 'p1', name: 'Striker', position: 'FWD', wage: 0, transferValue: 0, age: 25, morale: 75, attributes: { attack: 75, defence: 20, teamwork: 50, charisma: 50, publicPotential: 70 }, truePotential: 70, curve: { shape: 'SHALLOW_BELL' as const, peakHeight: 3 as const, startAge: 18, retirementAge: 36, baseAttack: 50, baseDefence: 50 }, contractExpiresWeek: 46, stats: { goals: 0, assists: 0, cleanSheets: 0, appearances: 0, averageRating: 0 } },
        { id: 'p2', name: 'Midfielder', position: 'MID', wage: 0, transferValue: 0, age: 25, morale: 75, attributes: { attack: 55, defence: 50, teamwork: 65, charisma: 50, publicPotential: 65 }, truePotential: 65, curve: { shape: 'SHALLOW_BELL' as const, peakHeight: 3 as const, startAge: 18, retirementAge: 36, baseAttack: 50, baseDefence: 50 }, contractExpiresWeek: 46, stats: { goals: 0, assists: 0, cleanSheets: 0, appearances: 0, averageRating: 0 } },
        { id: 'p3', name: 'Defender', position: 'DEF', wage: 0, transferValue: 0, age: 25, morale: 75, attributes: { attack: 30, defence: 62, teamwork: 55, charisma: 40, publicPotential: 55 }, truePotential: 55, curve: { shape: 'SHALLOW_BELL' as const, peakHeight: 3 as const, startAge: 18, retirementAge: 36, baseAttack: 50, baseDefence: 50 }, contractExpiresWeek: 46, stats: { goals: 0, assists: 0, cleanSheets: 0, appearances: 0, averageRating: 0 } },
        { id: 'p4', name: 'Keeper', position: 'GK', wage: 0, transferValue: 0, age: 25, morale: 75, attributes: { attack: 15, defence: 68, teamwork: 55, charisma: 40, publicPotential: 60 }, truePotential: 60, curve: { shape: 'SHALLOW_BELL' as const, peakHeight: 3 as const, startAge: 18, retirementAge: 36, baseAttack: 50, baseDefence: 50 }, contractExpiresWeek: 46, stats: { goals: 0, assists: 0, cleanSheets: 0, appearances: 0, averageRating: 0 } },
      ],
      staff: [],
      facilities: [],
      reputation: 50,
  ...
  it('form affects team modifier', () => {
    const baseClub: Club = {
      ...
      wageBudget: 0,
      squad: [
        { id: 'p1', name: 'Player', position: 'FWD', wage: 0, transferValue: 0, age: 25, morale: 75, attributes: { attack: 50, defence: 20, teamwork: 45, charisma: 40, publicPotential: 45 }, truePotential: 45, curve: { shape: 'SHALLOW_BELL' as const, peakHeight: 3 as const, startAge: 18, retirementAge: 36, baseAttack: 50, baseDefence: 50 }, contractExpiresWeek: 46, stats: { goals: 0, assists: 0, cleanSheets: 0, appearances: 0, averageRating: 0 } },
      ],
      staff: [],
      facilities: [],
      reputation: 50,

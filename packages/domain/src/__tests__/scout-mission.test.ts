  ...
  function stateWithTarget(): GameState {
    ...
    return reduceEvent(state, {
      ...
      target: {
        ...
        truePotential: 72, curve: { shape: 'SHALLOW_BELL' as const, peakHeight: 3 as const, startAge: 18, retirementAge: 36, baseAttack: 50, baseDefence: 50 }, contractExpiresWeek: 0,
  ...
  it('emits SCOUT_TRANSFER_COMPLETED at week 21, adds player to squad, deducts fee', () => {
    ...
    state = reduceEvent(state, {
      ...
      target: {
        ...
        truePotential: 67, curve: { shape: 'SHALLOW_BELL' as const, peakHeight: 3 as const, startAge: 18, retirementAge: 36, baseAttack: 50, baseDefence: 50 }, contractExpiresWeek: 0,
